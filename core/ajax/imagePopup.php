                        ...
                        <div class="img-popup-tweet-wrap-inner">
                            ...
                            <div class="img-popup-tweet-right">
                                <div class="img-popup-tweet-right-headline">
                                    <a href="<?php echo BASE_URL.$tweet->username; ?>"><?php echo $tweet->screenName; ?></a><span>@<?php echo $tweet->username.'-'.$tweet->postedOn; ?> - DATE-TIME</span>
                                </div>
                                <div class="img-popup-tweet-right-body">
                                    <?php  echo $getFromT->getTweetLink($tweet->status); ?>
                                </div>
                            </div>
                        </div>
                    </div>
