$(function(){
    $('.follow-btn').click(function(){
        ...
        if($button.hasClass('following-btn')){
            $.post('http://localhost/twitter/core/ajax/follow.php', {unfollow:followID}, function(data){
            ...
            $.post('http://localhost/twitter/core/ajax/follow.php', {follow:followID}, function(data){
                data = JSON.parse(data);
